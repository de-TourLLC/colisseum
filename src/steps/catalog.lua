...
local extra = {
    ...
    { "control-flow-flatten", "Flattens top-level control flow into a shuffled state-machine dispatcher.", 2 },
    ...
    { "register-vm", "Compiles to ChaCha-encrypted register bytecode run by the embedded register VM with per-build opcode permutation; 2-6x faster than the tree-walker, Lua + Luau, no loadstring.", 2 },
