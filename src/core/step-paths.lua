...
local groups = {
    ...
    literals = { "boolean-normalize", "constant-array", "decimal-padding", "literal-grouping", "literal-padding", "nil-normalize", "numeric-base-normalize", "numeric-canonicalization", "numbers", "numeric-fibonacci", "quote-normalize", "split-strings", "string-byte-encoding", "strings" },
